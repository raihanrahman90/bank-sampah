...
export default function Home() {
  ...
  return (
    <div className="h-[100vh] bg-custom-primary">
      ...
      <div className="flex flex-col items-start justify-start h-[60vh] w-full fixed bottom-0 left-0 rounded-t-3xl shadow-xl p-4 bg-custom-secondary text-white">
        <h1 className="text-xl font-bold text-background mb-3">
          KATEGORI LAYANAN
        </h1>
        <div className="flex flex-wrap items-start gap-5">
          {menu.map((t) => (
            <Link href={t.link} key={t.link}>
              <div className="w-[100px] h-fit" key={t.title}>
                <div className="h-[70px] w-full bg-background rounded-xl flex justify-center relative">
                  <Image
                    src={t.image}
                    alt={t.title}
